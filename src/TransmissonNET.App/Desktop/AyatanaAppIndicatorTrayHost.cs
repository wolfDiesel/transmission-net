...
internal sealed class AyatanaAppIndicatorTrayHost : ILinuxTrayHost
{
    ...
    private const string IndicatorId = "transmission-net";
    ...
    private AyatanaAppIndicatorTrayHost(string? iconPath) => _iconPath = iconPath;
    ...
    public static ILinuxTrayHost? TryCreate(string? iconPath)
    {
        ...
        try
        {
            ...
            return new AyatanaAppIndicatorTrayHost(iconPath);
        }
        catch (Exception ex)
        {
    ...
    private static void ApplyIcon(IntPtr indicator, string? iconFilePath, string iconName)
    {
        ...
        {
            s_appIndicatorSetIconFull!(indicator, iconFilePath, "TransmissionNET");
            return;
        }
