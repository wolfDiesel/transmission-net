...
{
    public const string TrayPngFileName = "transmission-net-tray.png";
    public const string AppPngFileName = "transmission-net.png";
    ...
    private static IEnumerable<string> CandidatePaths(params string[] fileNames)
    {
        ...
        foreach (var fileName in fileNames)
        {
            ...
            yield return Path.Combine(baseDir, "wwwroot", fileName);
        }
    }
}
