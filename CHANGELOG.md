...
- RuTracker search: report request timeouts as a clear timeout message (not a vague “operation canceled”); provider errors now surface as toast notifications instead of the status bar.
